...
public class PackHandler {
    ...
    public static File resourcesDirectory = new File(Minecraft.getInstance().gameDirectory, "resources/");

    public static void init() {

        if (LoadMyResources.config != null) {
            resourcesDirectory = new File(Minecraft.getInstance().gameDirectory, LoadMyResources.config.getOrDefault("resource_path", "resources/"));
        } else {
